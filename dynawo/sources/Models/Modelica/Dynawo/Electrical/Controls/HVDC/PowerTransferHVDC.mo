...
model PowerTransferHVDC "Power transfer model for HVDC"
  ...
  input Types.ActivePowerPu PRefSet1RawPu(start = PRefSet10Pu) "Raw reference active power of HVDC link 1 in p.u (base SnRef)";
  input Types.ActivePowerPu PRefSet2RawPu(start = PRefSet20Pu) "Raw reference active power of HVDC link 2 in p.u (base SnRef)";
