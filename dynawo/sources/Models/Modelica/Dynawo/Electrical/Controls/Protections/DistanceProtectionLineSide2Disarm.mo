...
model DistanceProtectionLineSide2Disarm "Simple triangular distance relay, disconnects side 2 of the protected line when the apparent impedance in within a protected zone for longer than a set duration. Can no longer disarm once the circuit-breaker signal is sent."
...
public
  ...
  parameter Types.Time CircuitBreakerTime "Time required to open the circuit breaker in seconds, included in 'time delay of trip in zone X'";
...
equation
  assert(CircuitBreakerTime < T1, "CircuitBreakerTime should be included (thus smaller) than the tripping times");
...
end DistanceProtectionLineSide2Disarm;
