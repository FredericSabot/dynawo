...
model DistanceProtectionLineSide1Disarm "Simple triangular distance relay, disconnects side 1 of the protected line when the apparent impedance in within a protected zone for longer than a set duration. Can no longer disarm once the circuit-breaker signal is sent."
...
end DistanceProtectionLineSide1Disarm;
