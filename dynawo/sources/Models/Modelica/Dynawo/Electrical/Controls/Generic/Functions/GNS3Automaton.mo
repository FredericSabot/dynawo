...
function GNS3Automaton "Function to call external automaton"
  import Dynawo.Electrical.Controls.Generic.GenericAutomatonConstants;

  extends Icons.Function;

  input Real initWallTime[2] "Wall-clock time when the automaton is called for the first time ([1] is part in seconds, [2] is part in nanoseconds)";
  ...
  external "C" callGNS3Automaton(initWallTime, timeActivation, inputs, inputsName, nbInputs, nbMaxInputs, outputs, outputsName, nbOutputs, nbMaxOuputs);
