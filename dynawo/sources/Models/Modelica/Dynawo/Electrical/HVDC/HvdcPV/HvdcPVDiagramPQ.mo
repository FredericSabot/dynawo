...
*/
  ...
  input Types.VoltageModulePu U1RefPu(start = U1Ref0Pu) "Voltage regulation set point in p.u (base UNom) at terminal 1";
  input Types.VoltageModulePu U2RefPu(start = U2Ref0Pu) "Voltage regulation set point in p.u (base UNom) at terminal 2";
  input Types.ReactivePowerPu Q1RefPu(start = Q1Ref0Pu) "Reactive power regulation set point in p.u (base SnRef) (receptor convention) at terminal 1";
  input Types.ReactivePowerPu Q2RefPu(start = Q2Ref0Pu) "Reactive power regulation set point in p.u (base SnRef) (receptor convention) at terminal 2";
